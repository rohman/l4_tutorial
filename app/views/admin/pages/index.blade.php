...
@section('main')
	<h1>List Page</h1>
	{{HTML::linkRoute('admin.pages.create', 'Add Page', array() ,array('class' => 'btn btn-primary btn-xs'))}}
		...
		<tbody>
			@foreach($pages as $page)
				<tr>
					...
					<td>
						{{ HTML::linkRoute('admin.pages.edit','Edit', array($page->id), array('class' => 'btn btn-success btn-xs')) }}
